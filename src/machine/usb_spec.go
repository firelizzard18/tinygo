...
func newStringDescriptor(s string) []byte {
...
func NewDeviceDescriptor(class, subClass, proto, packetSize0 uint8, vid, pid, bcdDevice uint16, im, ip, is, configs uint8) DeviceDescriptor {
	return DeviceDescriptor{deviceDescriptorSize, 1, 0x200, class, subClass, proto, packetSize0, vid, pid, bcdDevice, im, ip, is, configs}
}
